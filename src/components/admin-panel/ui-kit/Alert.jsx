    ...
    return (
        ...
        ${isOpen ? 'top-0' : '-top-32'}`}>
            <div className="flex justify-between py-3">
                <div className="flex">
                    <div>
                        {type === 'success' ? <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className='h-6 w-6 rounded-full text-green-500'
                            viewBox="0 0 20 20">
                            <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg> :
                            type === 'error' ? <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 text-red-500" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <div className={`${type === 'success' ? 'text-green-600' :
                        type === 'error' ? 'text-red-600' : 'text-amber-600'} self-center ml-3`}>
                ...
                <button className={`self-start ml-4 ${type === 'success' ? 'text-green-500' :
