...
const LayerSwitch = memo(function LayerSwitch({
	title,
	type,
	visible,
	onVisibleChange
		...
		<div className='form-control'>
			<label className='flex justify-between cursor-pointer label'>
				...
				<label className='inline-flex items-center cursor-pointer'>
					...
					/>
					<div
						className={`relative w-10 h-[22px] bg-gray-200 rounded-full peer peer-checked:after:translate-x-full 
          ...
          ${
						type === 'soil'
							? 'peer-checked:bg-[#993300]/80'
							: type === 'ecosystem'
								? 'peer-checked:bg-[#73ac13]/80'
								: 'peer-checked:bg-[#8b008b]/80'
					}
          `}
					></div>
				</label>
