							...
							<div className='mt-4'>
								<div className='mt-4 sm:flex sm:items-center sm:-mx-2'>
									<button
										...
										className='modal w-full px-4 py-2 font-medium tracking-wide text-gray-700 capitalize transition-colors duration-300 transform border border-gray-200 rounded-md sm:w-1/2 sm:mx-2 focus:outline-none'
									>
										{t('cancel')}
									</button>
									<button
										className={`modal w-full px-4 py-2 mt-3 font-medium tracking-wide text-white capitalize transition-colors duration-300 transform 
