...
export default function FileCard({
	...
	const fileTitle = (
		<div className='mt-1 flex flex-row min-w-0'>
			{/* <svg
	...
	return (
		<div className='flex flex-row overflow-hidden justify-start space-x-2 items-center'>
			{!isLoading ? (
				<a
			...
			{!isLoading ? (
				<button
					type='button'
					className='text-zinc-500 hover:text-zinc-800 duration-300 pt-[1px] ml-1'
					onClick={onDelete}
				>
					<svg
						width='800px'
						...
						fill='none'
						xmlns='http://www.w3.org/2000/svg'
						className='min-w-[10px] min-h-[10px] w-[10px] h-[10px]'
					>
						<g id='Menu / Close_LG'>
							<path
								id='Vector'
