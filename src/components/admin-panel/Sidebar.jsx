...
export default function Sidebar() {
    const content = [
        {
            ...
            svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-5 h-5 -translate-y-[1px]">
        ...
        },
        {
            url: 'ecosystems',
            title: 'Экосистемы',
            svg: <svg stroke="none" fill='currentColor' className="w-5 h-5" strokeWidth="0.1" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            url: 'publications',
            title: 'Публикации',
            svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-5 h-5 -translate-y-[1px]">
        ...
        },
        {
            url: 'authors',
            title: 'Авторы',
            svg: <svg class="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        },
        {
            url: 'news',
            title: 'Новости',
            svg: <svg stroke="none" fill='currentColor' className="w-5 h-5 -translate-y-[2px]" strokeWidth="0.1" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    const users = [
        {
            url: 'users',
            title: 'Пользователи',
            svg: <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" class="w-5 h-5">
    ...
    const LinkItem = ({ url, title, svg }) =>
        <Link href={`/admin/${url}`} className="flex items-center px-3 py-2 transition-colors duration-300 transform rounded-lg hover:bg-gray-100 hover:text-gray-700">
            ...
            <div className="flex flex-col justify-between flex-1 mt-6">
                <nav className="-mx-3 space-y-6 ">
                    <div className="space-y-3 ">
                        <label className="w-full px-3 text-sm text-gray-500 uppercase">Содержимое</label>
                        {content.map(item => LinkItem(item))}
                    </div>

                    <div className="space-y-3 ">
                        <label className="w-full px-3 text-sm text-gray-500 uppercase">Таксономия</label>
                        {taxonomy.map(item => LinkItem(item))}
                    </div>

                    <div className="space-y-3 ">
                        <label className="w-full px-3 text-sm text-gray-500 uppercase">Управление пользователями</label>
