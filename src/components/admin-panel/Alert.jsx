...
export default function Alert({ isOpen, title, message }) {
    const dispatch = useDispatch();

    return (
        <div className={`duration-300 fixed self-center mt-6 z-[100] border border-green-500 px-2 rounded-md bg-green-50 md:max-w-2xl md:mx-auto md:px-8
        ${isOpen ? 'top-0' : '-top-32'}`}>
