	...
	const RegisterForm = () => (
		...
		>
			<div className='flex items-center h-full justify-center px-4 pt-4 pb-20 lg:ml-[290px] text-center'>
				<div
					className='relative inline-block px-4 pt-5 pb-4 overflow-hidden text-left align-bottom transition-all 
	...
	return (
		<div className='flex flex-col w-fill space-y-4'>
			<div className='flex flex-row justify-between items-center'>
				<h1 className='sm:text-2xl text-xl font-semibold'>{t('users')}</h1>
