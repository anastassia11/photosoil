            ...
            <div className="sm:bg-white sm:shadow p-4 py-6 sm:p-6 sm:rounded-lg">
                <form onSubmit={handleSubmit(handleFormSubmit)}
                    ...
                    <div className="relative">
                        <button type='button' className="text-gray-400 absolute right-3 top-9 my-auto active:text-gray-600"
                    ...
                    {errors.server && <p className='text-red-500 text-sm mt-[2px]'>{errors.server.message}</p>}
                    <SubmitBtn isSubmitting={isSubmitting} btnText={t('login')} />
                </form>
            </div>
        </div>
    )
