			...
			<div className='max-w-screen-xl m-auto flex flex-col sm:space-y-24 space-y-12 sm:mx-8 mx-4'>
				<div className=''>
					<h2 className='sm:text-2xl text-xl font-semibold text-center'>
						Для чего нужна база даннных PhotoSOIL
					</h2>
					<p className='text-base mt-6'>
						Почвы обладают значительной морфологической изменчивостью даже в
						пределах одного почвенного типа. Однако многие «почвенные рисунки»,
						создаваемые горизонтными и внегоризонтными почвенными
						морфологическими элементами, никак не учитываются при
						классификационной диагностике почв. Почвенные «рисунки» очень трудно
						охарактеризовать в морфологическом описании, поэтому проще всего их
						обсуждать, имея под руками качественные фотографии почв. Тормозом в
						применении цифровых технологий является слабая представленность
						фотографий почв в сети Интернет. В распоряжении исследователей, как
						правило, находится личный материал, который не доступен научном
						сообществу и имеет региональную ограниченность.
					</p>
				</div>
				...
				<div className='flex sm:flex-row flex-col bg-white p-6 px-8 rounded-2xl border'>
					...
					<p className='sm:w-2/3 w-full text-base'>
						...
						содействия развитию сравнительных генетико-географических
						исследований. Она призвана расширить представления о морфологическом
						многообразии почв среди почвоведов и натуралистов.
					</p>
				</div>
				<div>
					<h2 className='sm:text-2xl text-xl font-semibold text-center'>
					...
					<div className='flex lg:flex-row flex-col space-y-4 lg:space-y-0 lg:space-x-4 space-x-0 mt-8'>
						<div className='flex flex-col bg-white py-6 px-8 rounded-2xl lg:w-1/3 w-full space-y-4 border hover:border-blue-600 duration-300 cursor-pointer'>
							...
							<p className='text-base '>
								Здесь содержатся фотографии почв. Почвы привязаны к карте по
								месту заложения почвенного разреза. Приведены краткие описания
								факторов почвообразования, особенностей строения и генезиса
								почвы. При наличии приводятся дополнительные фотографии
						...
						<div className='flex flex-col bg-white p-6 px-8 rounded-2xl lg:w-1/3 w-full space-y-4 border hover:border-blue-600 duration-300 cursor-pointer'>
							...
							<p className='text-base'>
								Эта категория наполняется фотографиями различных элементов
								строения почв, от очень малых, которые относятся к области
								микроморфологии, до имеющих размерность в первые метры. Эти
						...
						<div className='flex flex-col bg-white p-6 px-8 rounded-2xl lg:w-1/3 w-full space-y-4 border hover:border-blue-600 duration-300 cursor-pointer'>
							...
							<p className='text-base '>
								Категория создана для размещения фотографий, которые бы явным
