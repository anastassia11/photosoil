	...
	return (
		<div className='layer-menu'>
			<div className='relative'>
				<button
					type='button'
					className='duration-300 bg-white rounded-md p-1 shadow-md text-zinc-600 hover:text-zinc-800 hover:shadow-lg'
					onClick={() =>
						setDrapdownState({
							key: 'layer',
				...
				>
					<svg
						...
						fill='currentColor'
					>
						<path d='M9.06 13L16 16.856 22.94 13 16 9.144 9.06 13zM16 19.144L4.94 13 16 6.856 27.06 13 16 19.144zm0 3.712l9-5L27.06 19 16 25.144 4.94 19 7 17.856l9 5z'></path>
					</svg>
				</button>
				{
					<div
						className={`${drapdownState.key == 'layer' && drapdownState.isActive ? 'visible translate-y-1' : '-translate-y-4 invisible opacity-0'} 
					...
					>
						<ul className='py-2'>
							{layers.map(({ key, title }) => (
								<li
									key={key}
									className={`baseLayerSelector flex flex-row justify-between duration-300 cursor-pointer hover:text-blue-600 h-9 hover:bg-zinc-100  
                                    items-center px-4
